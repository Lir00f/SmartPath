...
export interface QueryInterfaceExt extends QueryInterface {
    ...
    getForeignKeyReferencesForTable(tableName: TableName, options?: QueryInterfaceOptions): Promise<SequelizeReference[]>;
    describeTable(tableName: TableName, options?: string | ({
        schema?: string;
