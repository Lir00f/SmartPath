import { ActionField, ActionResult, Caller, CollectionDecorator, CollectionSchema, DataSourceDecorator, Filter, RecordData } from '@forestadmin/datasource-toolkit';
...
export default class ActionCollectionDecorator extends CollectionDecorator {
    ...
    getForm(caller: Caller, name: string, data?: RecordData, filter?: Filter, metas?: {
        changedField: string;
