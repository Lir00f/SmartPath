...
export interface DeprecatedComputedDefinition<S extends TSchema = TSchema, N extends TCollectionName<S> = TCollectionName<S>> extends Omit<ComputedDefinition<S, N>, 'columnType'> {
